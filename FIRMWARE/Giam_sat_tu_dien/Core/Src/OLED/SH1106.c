...
uint8_t SH1106_Init(void) {
	...
	if (HAL_I2C_IsDeviceReady(SH1106_I2C_HANDLE, SH1106_I2C_ADDR, 1, 20000) != HAL_OK) {
		/* Return false */
		return 0;
	}
...
void SH1106_Fill(SH1106_COLOR_t color) {
	/* Set memory */
	memset(SH1106_Buffer, (color == SH1106_COLOR_BLACK) ? 0x00 : 0xF0, sizeof(SH1106_Buffer));
}
...
void SH1106_Write(char* str, FontDef_t* Font, uint16_t x, uint16_t y)
{
	SH1106_GotoXY(x, y);
	SH1106_Puts(str, Font, 1);
	SH1106_UpdateScreen();
}
